...
@Component({
  selector: 'app-verify-status-change',
  standalone: false,
  templateUrl: './verify-status-change.component.html',
  styleUrl: './verify-status-change.component.scss'
})
export class VerifyStatusChangeComponent {
  ...
  submit(formValue:any, e:any) {
    ...
    this.orderService.UpdateRequestPaymentStatus(payload).subscribe((res:any) => {
